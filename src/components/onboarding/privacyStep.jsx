...
const PrivacyStep = ({ user, onNext, disabled }) => {
  ...
  return (
    <motion.div
      ...
      <p className="mb-5 text-sm text-white/70">Please review how Catalogify handles your information.</p>
      ...
      <label className="mb-6 flex cursor-pointer items-start gap-3 text-left text-sm text-white/80">
        ...
        <span>I have read and agree to the Catalogify Privacy Policy.</span>
      </label>
