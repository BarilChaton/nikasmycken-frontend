...
const CategoryBreakdown = ({ items }) => {
  ...
  const maxAmount = Math.max(...sortedCategories.map(([, value]) => value.amount), 1)
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-sky-100">
                      {data.items} {data.items === 1 ? 'entry' : 'entries'}
                    </p>
                  </div>
                </div>
                  ...
                  <div
                    ...
                    <span
                      className={`text-xs font-semibold whitespace-nowrap ${
                        data.amount / maxAmount < 0.2 ? 'absolute left-full ml-2 text-white' : 'text-white'
                      }`}>
