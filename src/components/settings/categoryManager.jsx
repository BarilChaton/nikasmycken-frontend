...
const CategoryManager = () => {
  ...
  <div className="space-y-4">
    ...
    <div className="rounded-xl bg-white/10 p-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="rounded-xl bg-white px-4 text-sky-800"
        >
          <FiPlus/>
        </button>
      </div>
    ...
    >
      <div className="flex items-center justify-between">
        ...
        {category.subcategories?.map(sub=>(
          <div
            key={sub._key}
            className="mt-2 flex justify-between text-sm text-white/70"
          >
            <span>└ {sub.name}</span>
            <button
    ...
    {selectedCategory && (
      <div className="rounded-xl bg-white/10 p-4">
        <p className="mb-2 text-white"> Add subcategory to: <b> {selectedCategory.name}</b></p>
        <div className="flex gap-2">
          <input
