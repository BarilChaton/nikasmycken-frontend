  ...
  return (
    <div className={`h-dvh flex flex-col overflow-hidden lightModePrimaryBg`}>
      ...
      <main className="flex-1 min-h-0 overflow-hidden">
        {currentPage === 'home' && (
          <Feed setCurrentPage={setCurrentPage} setSelectedItem={setSelectedItem} user={user} />
        )}
        {currentPage === 'search' && (
          <Search setCurrentPage={setCurrentPage} setSelectedItem={setSelectedItem} user={user} />
        )}
        {currentPage === 'add' && <AddItem setCurrentPage={setCurrentPage} user={user} />}
        {currentPage === 'statistics' && (
          <Statistics setCurrentPage={setCurrentPage} setSelectedItem={setSelectedItem} user={user} />
        )}
